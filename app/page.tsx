...
export default function RoomConfigurator() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        if (roomMappings && billOfMaterials && finalProjectCosts && projectDataStr) {
          ...
          // Use the actual calculated costs from room configuration
    ...
    fetchData();
  }, [inflation, networkCost, miscellaneous, approvedCapex]);
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gray-50 p-6 rounded-lg shadow-md mb-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">Labour Cost (10%)</label>
